...
class Commission(models.Model):
    ...
    percent_per_item = models.DecimalField(max_digits=3, decimal_places=2, default=5.0, editable=False)
    fixed_per_item = models.DecimalField(max_digits=10, decimal_places=2, default=0, editable=False)
